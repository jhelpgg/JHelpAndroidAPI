 ...
 * @author JHelp
 */
public class ArrayDouble extends DatabaseType
{
    /**
     * Array of double
     */
     ...
     */
    public ArrayDouble(final int initalSize)
    {
        this.array = new double[Math.max(initalSize, 128)];
        this.size = 0;
    ...
    public void parse(String serialized)
    {
        ...
        this.array = byteArray.readDoubleArray();
    }
    ...
    public String serialize()
    {
        ...
        byteArray.writeDoubleArray(this.array);

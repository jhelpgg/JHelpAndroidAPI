...
public final class UtilMath
{
     ...
     * Epsilon
     */
    public static final double EPSILON       = UtilMath.max(Double.MIN_NORMAL,
                                                            Math.abs(Math.E - Math.exp(1)),
                                                            Math.abs(Math.PI - Math.acos(-1)));
    /**
     * Epsilon for floats
     */
    public static final float  EPSILON_FLOAT = UtilMath.max(Float.MIN_NORMAL, Math.abs(
            (float) Math.E - (float) Math.exp(1)), Math.abs(
            (float) Math.PI - (float) Math.acos(-1)));
    /**
     * PI / 2
     */
     ...
     *
     * @param real1 First double
     * @param real2 Second double
     ...
     *
     * @param integer Integer to have is factorial
     * @return integer!
     */
    ...
    /**
     * Return the given integer, if the integer is in [0, 255]. If integer<0, we return 0, if
     * integer>255, we return 255
     *
     ...
     *
     * @param doubles Doubles to have the maximum
     ...
     * Maximum of several double
     *
     * @param floats Doubles to have the maximum
     * @return Maximum of doubles
     */
    public static final float max(final float... floats)
    {
        float max = floats[0];
     ...
     *
     * @param integers Integer to have the maximum
     ...
     *
     * @param doubles Doubles to have the minimum
     ...
     * Minimum of several double
     *
     * @param floats Doubles to have the minimum
     * @return Minimum of doubles
     */
    public static final float min(final float... floats)
    {
        float min = floats[0];
     ...
     *
     * @param integers Integer to have the minimum
     ...
     */
    public static double PCubique(final double cp, final double p1, final double p2,
                                  final double p3, final double t)
    {
        final double u = 1d - t;
     ...
     * @param cub       Where write interpolations
     * @return Interpolations
     */
    public static double[] PCubiques(final double cp, final double p1, final double p2,
                                     final double p3, final int precision, double[] cub)
    {
        double step;
        double actual;
        int    i;
     ...
     * integer<sup>pow</sup>
     *
     * @param integer Integer to power of
     * @param pow     Power to put
     * @return The result
     */
     ...
     * @return Interpolation
     */
    public static double PQuadrique(final double cp, final double p1, final double p2,
                                    final double t)
    {
        final double u = 1d - t;
     ...
     * @param p2        Second control point
     * @param precision Number of interpolation
     * @param quad      Where write interpolations
     * @return Interpolations
     */
    public static double[] PQuadriques(final double cp, final double p1, final double p2,
                                       final int precision, double[] quad)
    {
        double step;
        double actual;
        int    i;
     ...
     * </table>
     *
     * @param real Double to have its sign
     ...
     * </table>
     *
     * @param integer Integer to have sign
     * @return Integer sign
     */
     ...
     * </table>
     *
     * @param integer Integer to have its sign

...
public final class Reflector
{
     ...
     */
    public final static void forceChangeField(final Object object, final String fieldName,
            ...
            throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException
    {
        ...
        if (field == null)
        {
            throw new NoSuchFieldException(
                    Debug.createMessage("The field ", fieldName, " not found in ", object.getClass()
                                                                                         .getName()));
        }
     ...
     * @param fieldName Field name
     * @param newValue  New value
     * @throws NoSuchFieldException     If field dosen't exists
     ...
     */
    public final static Object forceGetField(final Object object, final String fieldName)
            throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException
    {
        Field    field  = null;
        Class<?> clazz  = object.getClass();
     ...
     * @throws IllegalAccessException   If force failed
     */
    public final static Object forceGetStaticField(final Class<?> claz, final String fieldName)
            throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException
    {
        Field    field  = null;
        ...
        if (field == null)
        {
            throw new NoSuchFieldException(Debug.createMessage("The field ", fieldName,
                                                               " not found in ", claz.getName()));
        }
     ...
     */
    public final static void forceInvokeMethod(final Object object, final String methodName,
                                               final Class<?>[] types, final Object[] values)
            ...
            InvocationTargetException
    {
        ...
        while ((method == null) && (clazz != null))
        {
            if (allMethods != null)
            {
                ...
                {
                    if ((m.getName()
                          .equals(methodName) == true) && (Reflector.typeMatch(types,
                                                                               m.getParameterTypes()) == true))
                    {
                        method = m;
                        break;
                    }
     ...
     * If the method is non static, this method first try create an instance of the specified
     * class with a "little" constructor,
     * it use {@link #newInstance(Class)} to do it.<br>
     * <b>NOTE :</b>The method must be public, this method haven't rights to invoke other methods,
     * so if not public, not found
     * exception was throw
     *
     ...
     * @throws NoSuchMethodException     If the given method is not public, or not exists with the
     * parameters
     ...
     */
    public final static Object invokePublicMethod(final Class<?> clazz, final String methodName,
     ...
     * @throws InvocationTargetException When invoke failed
     */
    public final static Object invokePublicMethod(final Object instance, final String methodName,
                                                  final Object... parameters)
            throws NoSuchMethodException, IllegalArgumentException, IllegalAccessException,
            InvocationTargetException
    {
        ...
        final Class<?>[] types  = Reflector.obtainTypes(parameters);
        final Method     method = Reflector.obtainPublicMethod(instance.getClass(), methodName,
                                                               types);
     ...
     * @return {@code true} if the class extends or implements directly or not the class or
     * interface
     */
    ...
    public static final Object newInstanceWithParameters(Class<?> type, Object... parameters)
    {
        Class<?>[]           types           = Reflector.obtainTypes(parameters);
        final Constructor<?> constructeurs[] = type.getConstructors();
        Constructor<?>       constructor     = null;

        for (final Constructor<?> constructeur : constructeurs)
        {
            if (Reflector.typeMatch(types, constructeur.getParameterTypes()) == true)
            {
        ...
        {
            Debug.printException(exception, "Failed to create instance of ", type.getName());
            return null;
        }
    }
     ...
     * It first look for "little" public constructor, that is to say a constructor with few
     * parameters, if it founds default
     * constructor without parameters, it use it.<br>
     * If the constructor founds have parameters, it creates a instance of each parameters (on
     * calling itself) an the use them
     * for construct the instance.<br>
     * <b>BEWARE:</b>
     * <ul>
     * <li>In some case, it can falls in infinite loop</li>
     * <li>It is not human, so can't read documentation and may use illegal argument for create
     * the instance</li>
     * </ul>
     *
    ...
    public static final Object newInstance(Class<?> type)
    {
        ...
        if (type.getName()
                .equals(String.class.getName()) == true)
        {
            return "";
        }
     ...
     * <ul>
     * <li>In some case, it can falls in infinite loop</li>
     * <li>It is not human, so can't read documentation and can use illegal argument for create
     * the instance</li>
     * </ul>
     *
     ...
     * @throws ClassNotFoundException If the class can't be resolve
     */
    public static final Object newInstance(final String typeName, final ClassLoader classLoader)
     ...
     * @throws IllegalAccessException If force failed
     */
    public final static Field obtainField(final Object object, final String fieldName)
     ...
     */
    public final static Method obtainPublicMethod(final Class<?> clazz, final String methodName,
                                                  final Class<?>... types)

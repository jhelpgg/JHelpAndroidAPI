 ...
 * @author JHelp
 */
public class ByteArray extends DatabaseType
{
    /**
    ...
    /**
     * Parse serialized String to fill byte array
     *
    ...
    {
        this.clear();
        this.write(Base64.decode(serialized, Base64.DEFAULT));
    }

    /**
     * Serializz byte array to String
     *
    ...
    {
        return Base64.encodeToString(this.toArray(), Base64.DEFAULT);
    }
     ...
     *
     * @param <B>  Type of {@link Binarizable}
     * @param clas Class of the {@link Binarizable} to read
     * @return The read {@link Binarizable}
     * @throws Exception If the actual read data in the byte array doesn't represents the {@link
     *                   Binarizable} asked
     */
     ...
     * @throws Exception If the byte array doesn't contains an array of desired {@link
     *                   Binarizable} at the actual read index
     */
    ...
    public <E extends Enum> E readEnum(final Class<E> clas) throws Exception
    {
        ...
        return (E) clas.getMethod("valueOf", clas.getClass(), String.class)
                       .invoke(null, clas, name);
    }
    ...
    {
        return ((long) this.read() << 56L) | ((long) this.read() << 48L) | ((long) this.read() <<
                                                                                    40L) | (
                (long) this.read() << 32L) | ((long) this.read() << 24L) | ((long) this.read() <<
                                                                                    16L) | (
                (long) this.read() << 8L) | this.read();
    }
    ...
    public String readString()
    {
        ...
        return UtilIO.readUTF8(utf8, 0, length);
    }
     ...
     * @param binarizable {@link Binarizable} to write. {@code null} is accept
     */
     ...
     *
     * @param <B>   {@link Binarizable} type
     * @param array {@link Binarizable} array to write
     */
     ...
     * The number of bytes takes here is 4(Array length)+(NumberOfBoolean)/8, that mean if you
     * have to store several boolen, its
     * more efficient to use this method (Number of byte took for store data are less) if the
     * number of boolean is at least 5.<br>
    ...
    public void writeString(final String string)
    {
        ...
        final byte[] utf8 = UtilIO.toUTF8(string);
